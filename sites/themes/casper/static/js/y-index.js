$(document).ready(function() {
  ...
  //调用函数
  console.log(H);
  $('.y-banner .content').css('height',H);
  var bannerText = $('.y-banner .content .text');
  var textTop = (Height-bannerText.height())/2;
  console.log(textTop)
  $('.y-banner .content .text').css('paddingTop',textTop+'px');
  // banner动画
  $(".carousel").carousel({
    interval: 2000
  });
  ...
  // $('.email-product .view').css({ width: W, height: H });
  console.log(Height)
  // var imgT = (Height - $(".view img").height()) / 2 +$(window).scrollTop()-200+ "px";
  ...
  //   autoSwitch(titleCase,Case_example,triangle,infoText,suitText);
  // })
